...
CREATE TABLE `dfe_ctes` (
  ...
  `cnpj` varchar(14) COLLATE utf8_unicode_ci NOT NULL COMMENT 'CNPJ do emissor da CTe',
  `xNome` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Razão do emissor da CTe',
  `chCTe` varchar(44) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Chave da NFe',
